...
publishing {
  ...
  publications {
    register("mavenJava", MavenPublication::class) {
      ...
      pom {
        name.set("kotest-extensions-mockserver")
        description.set("Kotest Extensions for Mock Server")
        url.set("http://www.github.com/kotest/kotest-extensions-mockserver")

        scm {
          connection.set("scm:git:http://www.github.com/kotest/kotest-extensions-mockserver")
